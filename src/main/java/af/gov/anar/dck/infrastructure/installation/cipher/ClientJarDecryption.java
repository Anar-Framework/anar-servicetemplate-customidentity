package af.gov.anar.dck.infrastructure.installation.cipher;
...
import af.gov.anar.dck.infrastructure.installation.tpm.asymmetric.AsymmetricDecryptionService;
import af.gov.anar.dck.infrastructure.installation.tpm.asymmetric.AsymmetricEncryptionService;
import af.gov.anar.dck.infrastructure.installation.tpm.initailize.TPMInitialization;
import af.gov.anar.dck.infrastructure.constant.ApplicationGenericConstants;
import af.gov.anar.dck.infrastructure.installation.SoftwareInstallationHandler;
                ...
                Task<Boolean> verificationTask = new Task<Boolean>() {
                    ...
                    protected Boolean call() throws IOException, InterruptedException {
                        ...
                        if (isDbAvailable) {
                            ...
                            } catch (IOException |  af.gov.anar.core.infrastructure.exception.common.IOException exception) {
                            ...
                            LOGGER.error(ApplicationGenericConstants.CLIENT_JAR_DECRYPTION, ApplicationGenericConstants.APPLICATION_NAME,
                                    ApplicationGenericConstants.APPLICATION_ID, "DB Not Found, Terminating Application");
