...
public interface InstanceRepository extends JpaRepository<Instance, Long>  {
	...
	@Query("SELECT new af.gov.anar.dck.domain.model.Instance(i.id, i.active, i.title, i.version, i.currentStep, i.resolution, i.instanceSubmission, i.instanceFolderName, i.instanceStartTime, i.instanceEndTime, i.instanceDeviceId, i.isFirstUpdate,i.envSlug, i.owner, i.createdAt, i.updatedAt) from Instance i order by i.id")
	...
	@Query("SELECT new af.gov.anar.dck.domain.model.Instance(i.id, i.active, i.title, i.version, i.rowId, i.rowETag) FROM Instance i  where i.form.id=?1 and i.rowId IN (?2) order by i.rowId")
