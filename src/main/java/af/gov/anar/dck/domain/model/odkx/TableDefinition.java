...
public class TableDefinition {
     ...
     * @param displayName           the displayName of the table (JSON.parse() to
     *                              get viewable name)
     * @param type                  the string type of the table (must be one of
     *                              (keep this fully qualified!)
    ...
    public String toString() {
        return "TableDefinition [schemaETag=" + schemaETag + ", tableId=" + tableId + ", orderedColumns="
                + orderedColumns + "]";
    }
    ...
    public boolean equals(Object obj) {
        ...
        return (schemaETag == null ? other.schemaETag == null : schemaETag.equals(other.schemaETag))
                ...
                && (orderedColumns == null ? other.orderedColumns == null
                        : orderedColumns.equals(other.orderedColumns));
    }
