...
public class TableResourceList {
     ...
     * but all sort directions inverted and pass the webSafeBackwardCursor to obtain
    ...
    /**
     * together with the initial query, pass this in to return the next set of
     * results
     */
    @JsonProperty(required = false)
    ...
    /**
     * The entries in the manifest. This is and ordered list by tableId.
     */
    @JsonProperty(required = false)
    ...
    /**
     * If known, the ETag of the app-level files manifest is also returned.
     */
    @JsonProperty(required = false)
     ...
     * @param entries
     */
    public TableResourceList(ArrayList<TableResource> tables, String refetchCursor, String backCursor,
            String resumeCursor, boolean hasMore, boolean hasPrior) {
        if (tables == null) {
            this.tables = new ArrayList<TableResource>();
        } else {
            this.tables = tables;
    ...
    public boolean equals(Object obj) {
        ...
        boolean simpleResult = (tables == null ? other.tables == null
                : (other.tables != null && tables.size() == other.tables.size()))
                && (appLevelManifestETag == null ? other.appLevelManifestETag == null
                        : (appLevelManifestETag.equals(other.appLevelManifestETag)))
                && (webSafeRefetchCursor == null ? other.webSafeRefetchCursor == null
                        : (webSafeRefetchCursor.equals(other.webSafeRefetchCursor)))
                && (webSafeBackwardCursor == null ? other.webSafeBackwardCursor == null
                        : (webSafeBackwardCursor.equals(other.webSafeBackwardCursor)))
                && (webSafeResumeCursor == null ? other.webSafeResumeCursor == null
                        : (webSafeResumeCursor.equals(other.webSafeResumeCursor)))
                && (hasMoreResults == other.hasMoreResults) && (hasPriorResults == other.hasPriorResults);
