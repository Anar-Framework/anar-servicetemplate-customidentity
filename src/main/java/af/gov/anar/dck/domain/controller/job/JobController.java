package af.gov.anar.dck.domain.controller.job;


import af.gov.anar.dck.domain.jobs.CronJob;
import af.gov.anar.dck.domain.jobs.SimpleJob;
import af.gov.anar.dck.domain.jobs.service.JobSchedularService;
import com.fasterxml.jackson.databind.JsonNode;
import com.fasterxml.jackson.databind.ObjectMapper;
import af.gov.anar.dck.domain.util.enumeration.SchedularServerResponseCode;
import af.gov.anar.dck.domain.util.enumeration.ServerResponse;
