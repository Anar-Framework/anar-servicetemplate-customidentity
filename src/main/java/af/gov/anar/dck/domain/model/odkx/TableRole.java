...
public enum TableRole {
    ...
    FILTERED_WRITER("Can read properties and read/write/delete filtered data.", TablePermission.READ_TABLE_ENTRY,
    ...
    READER("Can read properties and all data.", TablePermission.READ_TABLE_ENTRY, TablePermission.READ_ROW,
            TablePermission.UNFILTERED_READ, TablePermission.READ_PROPERTIES),

    WRITER("Can read properties and read/write/delete all data.", TablePermission.READ_TABLE_ENTRY,
            TablePermission.READ_ROW, TablePermission.WRITE_ROW, TablePermission.DELETE_ROW,
            TablePermission.UNFILTERED_READ, TablePermission.UNFILTERED_WRITE, TablePermission.UNFILTERED_DELETE,
            TablePermission.READ_PROPERTIES),
    ...
    public enum TablePermission {
        READ_TABLE_ENTRY, DELETE_TABLE, READ_ROW, WRITE_ROW, DELETE_ROW, UNFILTERED_READ, UNFILTERED_WRITE,
        UNFILTERED_DELETE, READ_PROPERTIES, WRITE_PROPERTIES, READ_ACL, WRITE_ACL, DELETE_ACL,
    }
