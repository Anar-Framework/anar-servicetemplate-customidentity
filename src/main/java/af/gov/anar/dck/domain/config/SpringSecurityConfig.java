...
import af.gov.anar.dck.domain.service.CustomDigestUserService;
import af.gov.anar.dck.domain.service.CustomUserService;
...
public class SpringSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    public static class DigestAuthSecurityConfiguration extends WebSecurityConfigurerAdapter {
        ...
        protected void configure(HttpSecurity http) throws Exception {
            ...
            http.antMatcher("/odk/**").authorizeRequests().antMatchers("/odk/**")
                    // .anyRequest()
    ...
    public static class JwtAuthSecurityConfiguration extends WebSecurityConfigurerAdapter {
        ...
        private static final String[] AUTH_WHITE_LIST = {
                ...
                "/api/login", 
                "/authenticate",
                "/api/public/instances/{instanceId}/image/{imageName}",
                "/api/public/instances/{instanceId}/video/{videoName}",
                "/api/public/instances/{instanceId}/audio/{audioName}",
                "/api/public/instances/{instanceId}/file/{fileName}",
                "/api/sms/sync/push",
                "/api/captcha/verify",
                "/api/forgotpassword",
                "/api/changepassword"
