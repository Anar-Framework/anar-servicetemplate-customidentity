package af.gov.anar.dck.domain.workflow.util;
...
public class WorkflowJsonUtil {
    ...
    public JSONObject getCurrentStep(String instanceCurrentStep, String workflowJson, List<String> allGroups) throws JSONException {
    ...
    private boolean hasAuthorizedGroup(String stepName, JSONArray steps, List<String> allGroups)
    {
